...
#define GRATICULE_LAT_LON_SHIFT 		1.0e-3 //1.0e-1
#endif

#ifndef MAX_GRATICULE_SPLIT_AMOUNT		//Maximum amount of the planisphere subdivision into tiles (when the graticule constructed)
#define MAX_GRATICULE_SPLIT_AMOUNT		100
#endif
...
#ifndef EPS_VAR					//Maximum floating operation error
#define EPS_VAR 				1.0e-6
#endif
